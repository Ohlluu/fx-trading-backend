...
class BullishProTraderGBPUSD:
    ...
    def __init__(self):
        ...
        self.active_trade_file = "/tmp/active_trade_bullish_gbpusd.json"
    ...
    def _determine_entry_state(self, confluences: List[Dict], grading: Dict,
        ...
        # Calculate ATR for GBP/USD
        atr = self._calculate_atr(h1_data, period=14)

        # GBP/USD-specific thresholds (FX pairs: more lenient than Gold)
    ...
    def _find_targets(self, current_price: float, confluences: List[Dict],
        ...
        """
        Find target levels for Step 4 trade worthiness (BULLISH GBP/USD)
    ...
    def _assess_trade_worthiness(self, entry_state_data: Dict, confluences: List[Dict],
        ...
        """
        Step 4: Trade-worthiness gating (R:R + stop sanity + target feasibility) (BULLISH GBP/USD)
...
async def get_bullish_pro_trader_analysis() -> Dict[str, Any]:
    """Get BULLISH professional trader analysis for GBP/USD (BUY setups only)"""
    system = BullishProTraderGBPUSD()

...
class BearishProTraderEURUSD:
    ...
    def __init__(self):
        ...
        self.active_trade_file = "/tmp/active_trade_bearish_eurusd.json"
    ...
    def _find_targets(self, current_price: float, confluences: List[Dict],
        ...
        """
        Find target levels for Step 4 trade worthiness (BEARISH EUR/USD)
    ...
    def _assess_trade_worthiness(self, entry_state_data: Dict, confluences: List[Dict],
        ...
        """
        Step 4: Trade-worthiness gating (R:R + stop sanity + target feasibility) (BEARISH EUR/USD)
...
async def get_bearish_pro_trader_analysis() -> Dict[str, Any]:
    """Get BEARISH professional trader analysis for EUR/USD (SELL setups only)"""
    system = BearishProTraderEURUSD()
